...
<html>
  <head>
    ...
    <title>pygame.transform &#8212; pygame v2.6.0 documentation</title>
...
<p>Shows whether or not smoothscale is using <code class="docutils literal notranslate"><span class="pre">MMX</span></code> or <code class="docutils literal notranslate"><span class="pre">SSE</span></code> _ACCELERATION.
If no _ACCELERATION is available then &quot;GENERIC&quot; is returned. For a x86
processor the level of _ACCELERATION to use is determined at runtime.</p>
...
<p>Sets smoothscale _ACCELERATION. Takes a string argument. A value of 'GENERIC'
turns off _ACCELERATION. 'MMX' uses <code class="docutils literal notranslate"><span class="pre">MMX</span></code> instructions only. 'SSE' allows
